...
<html>
  <head>
    ...
    <title>填空题详细</title><script language="javascript" src="js/Calendar.js"></script>
...
function check()
{
  ...
  bianhao=RS_result.getString("bianhao");kemu=RS_result.getString("kemu");shiti=RS_result.getString("shiti");nanyichengdu=RS_result.getString("nanyichengdu");daan=RS_result.getString("daan");
   ...
   <tr>
     <td width='11%'>编号：</td><td width='39%'><%=bianhao%></td><td width='11%'>科目：</td><td width='39%'><%=kemu%></td></tr><tr><td width='11%'>答案：</td><td width='39%'><%=daan%></td>
     <td width='11%'>难易程度：</td><td width='39%'><%=nanyichengdu%></td></tr><tr><td width='11%' height="108">试题：</td><td colspan="3"><%=shiti%></td>
