...
function gow()
{
	document.location.href="panduanti_add.jsp?jihuabifffanhao="+document.form1.jihuabifffanhao.value;
}
</script>
  <body >
  <%
 ...
 //islbdq }
   %>
  <form name="form1" id="form1" method="post" action="panduanti_add_post.jsp">
  添加判断题:
  <br><br>
   ...
   </select></td></tr><tr><td>答案：</td><td><select name='daan' id='daan'>
