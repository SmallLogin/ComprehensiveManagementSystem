...
public final class panduanti_005fadd_005fpost_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.print("<script>alert('该编号已经存在,请换其他编号!');window.history.go(-1);</script>");
  	  	...
  	  	out.print("<script>alert('添加成功!!');location.href='panduanti_add.jsp';</script>");
