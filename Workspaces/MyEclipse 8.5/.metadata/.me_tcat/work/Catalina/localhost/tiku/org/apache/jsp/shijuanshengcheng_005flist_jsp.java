...
public final class shijuanshengcheng_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
shijuanbianhao=RS_result.getString("shijuanbianhao");kemu=RS_result.getString("kemu");xuanzeti=RS_result.getString("xuanzeti");tiankongti=RS_result.getString("tiankongti");panduanti=RS_result.getString("panduanti");faburen=RS_result.getString("faburen");
 ...
 //zoxngxetxoxngjxvi 
      ...
      out.print(addtime );
      out.write("</td>\r\n");
      out.write("    <td width=\"60\" align=\"center\"><a href=\"shijuanshengcheng_updt.jsp?id=");
      out.print(id);
      out.write("\">修改</a> <a href=\"shijuan_detail2.jsp?id=");
      out.print(id);
      out.write("\">详细</a>  <a href=\"del.jsp?id=");
      out.print(id );
      out.write("&tablename=shijuanshengcheng\" onClick=\"return confirm('真的要删除？')\">删除</a></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  \t");
...
//yougongzitongji
      ...
      out.write("条/页　<a href=\"shijuanshengcheng_list.jsp?page=1\">首页</a>　<a href=\"shijuanshengcheng_list.jsp?page=");
      out.print( curpage-1);
      out.write("\">上一页</a>　<A href=\"shijuanshengcheng_list.jsp?page=");
      out.print( curpage+1);
      out.write("\">下一页</A>　<a href=\"shijuanshengcheng_list.jsp?page=");
      out.print(zys );
