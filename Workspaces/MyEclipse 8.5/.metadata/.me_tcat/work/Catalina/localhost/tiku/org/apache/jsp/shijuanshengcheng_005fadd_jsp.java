...
public final class shijuanshengcheng_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("{\r\n");
      out.write("\tdocument.location.href=\"shijuanshengcheng_add.jsp?jihuabifffanhao=\"+document.form1.jihuabifffanhao.value;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("  <body >\r\n");
      out.write("  ");
 ...
 //islbdq }
      ...
      out.write("\r\n");
      out.write("  <form name=\"form1\" id=\"form1\" method=\"post\" action=\"shijuanshengcheng_add_post.jsp\">\r\n");
      out.write("  添加试卷生成:\r\n");
      out.write("  <br><br>\r\n");
      out.write("   <table width=\"100%\" border=\"1\" align=\"center\" cellpadding=\"3\" cellspacing=\"1\" bordercolor=\"#00FFFF\" style=\"border-collapse:collapse\">    <tr><td>试卷编号：</td><td><input name='shijuanbianhao' type='text' id='shijuanbianhao' value='' style='border:solid 1px #000000; color:#666666' />&nbsp;*</td></tr><tr><td>科目：</td><td><select name='kemu' id='kemu'>");
sql="select kemu from kemuxinxi order by id desc";RS_result=connDbBean.executeQuery(sql);while(RS_result.next()){
      ...
      out.write("</select>&nbsp;*</td></tr><tr><td>选择题：</td><td><input name='xuanzeti' type='text' id='xuanzeti' value='5' style='border:solid 1px #000000; color:#666666' />\r\n");
      out.write("   个</td>\r\n");
      out.write("   </tr><tr><td>填空题：</td><td><input name='tiankongti' type='text' id='tiankongti' value='5' style='border:solid 1px #000000; color:#666666' />\r\n");
      out.write("个</td>\r\n");
      out.write("   </tr><tr><td>判断题：</td><td><input name='panduanti' type='text' id='panduanti' value='5' style='border:solid 1px #000000; color:#666666' />\r\n");
      out.write("个</td>\r\n");
      out.write("   </tr><tr><td>发布人：</td><td><input name='faburen' type='text' id='faburen' style='border:solid 1px #000000; color:#666666' value='");
