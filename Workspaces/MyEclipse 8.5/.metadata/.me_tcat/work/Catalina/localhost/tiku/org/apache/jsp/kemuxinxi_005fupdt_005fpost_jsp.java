...
public final class kemuxinxi_005fupdt_005fpost_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sql="update kemuxinxi set kemu='"+kemu+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('修改成功!!');location.href='kemuxinxi_list.jsp';</script>");
