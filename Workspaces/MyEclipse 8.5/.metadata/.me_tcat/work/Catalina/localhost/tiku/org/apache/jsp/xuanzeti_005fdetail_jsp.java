...
public final class xuanzeti_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>选择题详细</title><script language=\"javascript\" src=\"js/Calendar.js\"></script>\r\n");
      out.write("\t\r\n");
  ...
  bianhao=RS_result.getString("bianhao");kemu=RS_result.getString("kemu");shiti=RS_result.getString("shiti");nanyichengdu=RS_result.getString("nanyichengdu");xuanxiangA=RS_result.getString("xuanxiangA");xuanxiangB=RS_result.getString("xuanxiangB");xuanxiangC=RS_result.getString("xuanxiangC");xuanxiangD=RS_result.getString("xuanxiangD");daan=RS_result.getString("daan");
      ...
      out.print(bianhao);
      out.write("</td><td width='11%'>科目：</td>\r\n");
      ...
      out.write("</td></tr><tr><td width='11%'>选项A：</td>\r\n");
      out.write("     <td width='39%'>");
      out.print(xuanxiangA);
      out.write("</td><td width='11%'>选项B：</td><td width='39%'>");
      out.print(xuanxiangB);
      out.write("</td></tr>\r\n");
      out.write("     <tr><td width='11%'>选项C：</td><td width='39%'>");
      out.print(xuanxiangC);
      out.write("</td><td width='11%'>\r\n");
      out.write("     选项D：</td><td width='39%'>");
      out.print(xuanxiangD);
      out.write("</td></tr>\r\n");
      out.write("     <tr><td width='11%' height=\"133\">试题：</td><td colspan=\"3\">");
      out.print(shiti);
      out.write("</td>\r\n");
