...
public final class tiankongti_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("{\r\n");
      out.write("\tif(document.form1.bianhao.value==\"\"){alert(\"请输入编号\");document.form1.bianhao.focus();return false;}if(document.form1.kemu.value==\"\"){alert(\"请输入科目\");document.form1.kemu.focus();return false;}if(document.form1.daan.value==\"\"){alert(\"请输入答案\");document.form1.daan.focus();return false;}\r\n");
      out.write("}\r\n");
      out.write("function gow()\r\n");
      out.write("{\r\n");
      out.write("\tdocument.location.href=\"tiankongti_add.jsp?jihuabifffanhao=\"+document.form1.jihuabifffanhao.value;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("  <body >\r\n");
      out.write("  ");
 ...
 //islbdq }
      ...
      out.write("\r\n");
      out.write("  <form name=\"form1\" id=\"form1\" method=\"post\" action=\"tiankongti_add_post.jsp\">\r\n");
      out.write("  添加填空题:\r\n");
      out.write("  <br><br>\r\n");
...
sql="select kemu from kemuxinxi order by id desc";RS_result=connDbBean.executeQuery(sql);while(RS_result.next()){
      ...
      out.write("</select>&nbsp;*</td></tr><tr><td>试题：</td><td>\r\n");
      out.write("   <textarea name=\"shiti\" id=\"shiti\" rows=\"3\" cols=\"60\"></textarea>\r\n");
      ...
      out.write("   </select></td></tr><tr><td>答案：</td><td><input name='daan' type='text' id='daan' value='' style='border:solid 1px #000000; color:#666666' />&nbsp;*</td></tr>\r\n");
      out.write("    <tr>\r\n");
      out.write("      <td>&nbsp;</td>\r\n");
