...
public final class tiankongti_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>填空题</title><LINK href=\"css.css\" type=text/css rel=stylesheet>\r\n");
...
ResultSet RS_result;
 ...
 sql="select kemu from kemuxinxi order by id desc";RS_result=connDbBean.executeQuery(sql);while(RS_result.next()){
      ...
      out.write("    <td bgcolor='#CCFFFF'>编号</td><td bgcolor='#CCFFFF'>科目</td><td bgcolor='#CCFFFF'>难易程度</td><td bgcolor='#CCFFFF'>答案</td>\r\n");
  ...
  int curpage=1;//当前页
				...
				String fysql="select count(id) as ss from tiankongti";
...
if(((curpage-1)*page_record)==0 || curpage==0)
  ...
  sql="select  * from tiankongti where 1=1 ";
   ...
   {
   String tempsql="select  id from tiankongti order by id desc limit 0,"+(curpage-1)*page_record+"";
  ...
  sql="select  * from tiankongti where id not in ("+tempidstring+")  ";
  }
...
bianhao=RS_result.getString("bianhao");kemu=RS_result.getString("kemu");shiti=RS_result.getString("shiti");nanyichengdu=RS_result.getString("nanyichengdu");daan=RS_result.getString("daan");
 ...
 //zoxngxetxoxngjxvi 
      ...
      out.print(addtime );
      out.write("</td>\r\n");
      out.write("    <td width=\"60\" align=\"center\"><a href=\"tiankongti_updt.jsp?id=");
      out.print(id);
      out.write("\">修改</a> <a href=\"tiankongti_detail.jsp?id=");
      out.print(id);
      out.write("\">详细</a>  <a href=\"del.jsp?id=");
      out.print(id );
      out.write("&tablename=tiankongti\" onClick=\"return confirm('真的要删除？')\">删除</a></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  \t");
...
//yougongzitongji
      ...
      out.write("条/页　<a href=\"tiankongti_list.jsp?page=1\">首页</a>　<a href=\"tiankongti_list.jsp?page=");
      out.print( curpage-1);
      out.write("\">上一页</a>　<A href=\"tiankongti_list.jsp?page=");
      out.print( curpage+1);
      out.write("\">下一页</A>　<a href=\"tiankongti_list.jsp?page=");
      out.print(zys );
