...
public final class panduanti_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("{\r\n");
      out.write("\tdocument.location.href=\"panduanti_add.jsp?jihuabifffanhao=\"+document.form1.jihuabifffanhao.value;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("  <body >\r\n");
      out.write("  ");
 ...
 //islbdq }
      ...
      out.write("\r\n");
      out.write("  <form name=\"form1\" id=\"form1\" method=\"post\" action=\"panduanti_add_post.jsp\">\r\n");
      out.write("  添加判断题:\r\n");
      out.write("  <br><br>\r\n");
...
sql="select kemu from kemuxinxi order by id desc";RS_result=connDbBean.executeQuery(sql);while(RS_result.next()){
      ...
      out.write("   </select></td></tr><tr><td>答案：</td><td><select name='daan' id='daan'>\r\n");
