...
public final class panduanti_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>判断题</title><LINK href=\"css.css\" type=text/css rel=stylesheet>\r\n");
...
bianhao=RS_result.getString("bianhao");kemu=RS_result.getString("kemu");shiti=RS_result.getString("shiti");nanyichengdu=RS_result.getString("nanyichengdu");daan=RS_result.getString("daan");
 ...
 //zoxngxetxoxngjxvi 
      ...
      out.print(addtime );
      out.write("</td>\r\n");
      out.write("    <td width=\"60\" align=\"center\"><a href=\"panduanti_updt.jsp?id=");
      out.print(id);
      out.write("\">修改</a> <a href=\"panduanti_detail.jsp?id=");
      out.print(id);
      out.write("\">详细</a>  <a href=\"del.jsp?id=");
      out.print(id );
      out.write("&tablename=panduanti\" onClick=\"return confirm('真的要删除？')\">删除</a></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  \t");
...
//yougongzitongji
      ...
      out.write("条/页　<a href=\"panduanti_list.jsp?page=1\">首页</a>　<a href=\"panduanti_list.jsp?page=");
      out.print( curpage-1);
      out.write("\">上一页</a>　<A href=\"panduanti_list.jsp?page=");
      out.print( curpage+1);
      out.write("\">下一页</A>　<a href=\"panduanti_list.jsp?page=");
      out.print(zys );
