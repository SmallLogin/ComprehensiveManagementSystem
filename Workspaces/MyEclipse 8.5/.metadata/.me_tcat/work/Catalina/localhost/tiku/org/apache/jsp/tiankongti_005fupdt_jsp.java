...
public final class tiankongti_005fupdt_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>填空题</title><script language=\"javascript\" src=\"js/Calendar.js\"></script>\r\n");
  ...
  String id=request.getParameter("id");
      ...
      out.write("\r\n");
      out.write("  <form name=\"form1\" id=\"form1\" method=\"post\" action=\"tiankongti_updt_post.jsp?id=");
      out.print(id );
      out.write("\">\r\n");
      out.write("  修改填空题:\r\n");
      out.write("  <br><br>\r\n");
...
sql="select kemu from kemuxinxi order by id desc";RS_result=connDbBean.executeQuery(sql);while(RS_result.next()){
      ...
      out.write("';</script><tr><td>答案：</td><td><input name='daan' type='text' id='daan' value='");
      out.print( daan);
