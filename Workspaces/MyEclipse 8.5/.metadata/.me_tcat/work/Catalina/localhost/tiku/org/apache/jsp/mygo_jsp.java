...
public final class mygo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (request.getSession().getAttribute("cx").equals("管理员") || request.getSession().getAttribute("cx").equals("教师"))
{
