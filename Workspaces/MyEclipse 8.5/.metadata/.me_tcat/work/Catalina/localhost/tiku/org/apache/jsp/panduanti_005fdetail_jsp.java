...
public final class panduanti_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>判断题详细</title><script language=\"javascript\" src=\"js/Calendar.js\"></script>\r\n");
      out.write("\t\r\n");
  ...
  bianhao=RS_result.getString("bianhao");kemu=RS_result.getString("kemu");shiti=RS_result.getString("shiti");nanyichengdu=RS_result.getString("nanyichengdu");daan=RS_result.getString("daan");
      ...
      out.print(kemu);
      out.write("</td></tr><tr><td width='11%'>试题：</td><td width='39%'>");
      out.print(shiti);
      out.write("</td><td width='11%'>难易程度：</td><td width='39%'>");
      out.print(nanyichengdu);
      out.write("</td></tr><tr><td width='11%'>答案：</td><td width='39%'>");
      out.print(daan);
      out.write("</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td colspan=4 align=center><input type=button name=Submit5 value=返回 onClick=\"javascript:history.back()\" /></td></tr>\r\n");
      out.write("    \r\n");
      out.write("  </table>\r\n");
      out.write("\r\n");
      out.write("  </body>\r\n");
