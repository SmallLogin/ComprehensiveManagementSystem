...
public final class panduanti_005fupdt_005fpost_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sql="update panduanti set bianhao='"+bianhao+"',kemu='"+kemu+"',shiti='"+shiti+"',nanyichengdu='"+nanyichengdu+"',daan='"+daan+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('修改成功!!');location.href='panduanti_list.jsp';</script>");
