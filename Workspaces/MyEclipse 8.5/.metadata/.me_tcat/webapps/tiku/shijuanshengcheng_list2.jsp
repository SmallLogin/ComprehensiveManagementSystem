...
<html>
  <head>
    ...
    <title>试卷生成</title><LINK href="css.css" type=text/css 
rel=stylesheet>
...
%>
  <tr>
    ...
    <td width="60" align="center"><a href="shijuanshengcheng_updt.jsp?id=<%=id%>">修改</a> <a href="shijuanshengcheng_detail.jsp?id=<%=id%>">详细</a>  <a href="del.jsp?id=<%=id %>&tablename=shijuanshengcheng" onclick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="shijuanshengcheng_list2.jsp?page=1">首页</a>　<a href="shijuanshengcheng_list2.jsp?page=<%= curpage-1%>">上一页</a>　<A href="shijuanshengcheng_list2.jsp?page=<%= curpage+1%>">下一页</A>　<a href="shijuanshengcheng_list2.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
