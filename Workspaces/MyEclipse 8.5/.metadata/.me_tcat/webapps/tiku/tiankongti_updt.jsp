...
<html>
  <head>
    ...
    <title>填空题</title><script language="javascript" src="js/Calendar.js"></script>
...
function check()
{
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="tiankongti_updt_post.jsp?id=<%=id %>">
  修改填空题:
  <br><br>
  <%
  ...
  bianhao=RS_result.getString("bianhao");kemu=RS_result.getString("kemu");shiti=RS_result.getString("shiti");nanyichengdu=RS_result.getString("nanyichengdu");daan=RS_result.getString("daan");
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     </select></td></tr><script language="javascript">document.form1.nanyichengdu.value='<%=nanyichengdu%>';</script><tr><td>答案：</td><td><input name='daan' type='text' id='daan' value='<%= daan%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
    <tr>
      <td>&nbsp;</td>
