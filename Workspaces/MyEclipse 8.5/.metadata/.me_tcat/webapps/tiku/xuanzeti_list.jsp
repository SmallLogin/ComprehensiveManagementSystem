...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>编号</td><td bgcolor='#CCFFFF'>科目</td><td bgcolor='#CCFFFF'>难易程度</td><td bgcolor='#CCFFFF'>选项A</td><td bgcolor='#CCFFFF'>选项B</td><td bgcolor='#CCFFFF'>选项C</td><td bgcolor='#CCFFFF'>选项D</td><td bgcolor='#CCFFFF'>答案</td>
...
%>
  <tr>
    ...
    <td width="60" align="center"><a href="xuanzeti_updt.jsp?id=<%=id%>">修改</a> <a href="xuanzeti_detail.jsp?id=<%=id%>">详细</a>  <a href="del.jsp?id=<%=id %>&tablename=xuanzeti" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="xuanzeti_list.jsp?page=1">首页</a>　<a href="xuanzeti_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="xuanzeti_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="xuanzeti_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
